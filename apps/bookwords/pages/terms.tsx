...
export default function Terms() {
  return (
    <div className="prose mx-auto p-4">
      ...
      <h1 className="m-0 py-2">Terms of Service</h1>
      <p className="m-0 p-0 text-gray-500">Last updated January 18, 2023</p>
      <h2 className="m-0 pt-4">Table of Contents</h2>
      <ol>
        <li>
          <a href="#agreement-to-terms" className="text-blue-600">
            AGREEMENT TO TERMS
          </a>
        </li>
        <li>
          <a href="#intellectual-property" className="text-blue-600">
            INTELLECTUAL PROPERTY RIGHTS
          </a>
        </li>
        <li>
          <a href="#user-representations" className="text-blue-600">
            USER REPRESENTATIONS
          </a>
        </li>
        <li>
          <a href="#user-registration" className="text-blue-600">
            USER REGISTRATION
          </a>
        </li>
        <li>
          <a href="#prohibited-activities" className="text-blue-600">
            PROHIBITED ACTIVITIES
          </a>
        </li>
        <li>
          <a href="#user-generated-contribution" className="text-blue-600">
            USER GENERATED CONTRIBUTION
          </a>
        </li>
        <li>
          <a href="#contribution-license" className="text-blue-600">
            CONTRIBUTION LICENSE
          </a>
        </li>
        <li>
          <a href="#social-media" className="text-blue-600">
            SOCIAL MEDIA
          </a>
        </li>
        <li>
          <a href="#submissions" className="text-blue-600">
            SUBMISSIONS
          </a>
        </li>
        <li>
          <a href="#third-party-website-and-content" className="text-blue-600">
            THIRD-PARTY WEBSITE AND CONTENT
          </a>
        </li>
        <li>
          <a href="#advertisers" className="text-blue-600">
            ADVERTISERS
          </a>
        </li>
        <li>
          <a href="#site-management" className="text-blue-600">
            SITE MANAGEMENT
          </a>
        </li>
        <li>
        ...
        <li>
          <a href="#copyright-infringements" className="text-blue-600">
            COPYRIGHT INFRINGEMENTS
          </a>
        </li>
        <li>
          <a href="#term-and-termination" className="text-blue-600">
            TERM AND TERMINATION
          </a>
        </li>
        <li>
          <a href="#modifications-and-interruptions" className="text-blue-600">
            MODIFICATIONS AND INTERRUPTIONS
          </a>
        </li>
        <li>
          <a href="#governing-law" className="text-blue-600">
            GOVERNING LAW
          </a>
        </li>
        <li>
          <a href="#dispute-resolution" className="text-blue-600">
            DISPUTE RESOLUTION
          </a>
        </li>
        <li>
          <a href="#corrections" className="text-blue-600">
            CORRECTIONS
          </a>
        </li>
        <li>
          <a href="#disclaimer" className="text-blue-600">
            DISCLAIMER
          </a>
        </li>
        <li>
          <a href="#limitations-of-liability" className="text-blue-600">
            LIMITATIONS OF LIABILITY
          </a>
        </li>
        <li>
          <a href="#indemnification" className="text-blue-600">
            INDEMNIFICATION
          </a>
        </li>
        <li>
          <a href="#user-data" className="text-blue-600">
            USER DATA
          </a>
        </li>
        <li>
        ...
        <li>
          <a href="#california-users-and-residents" className="text-blue-600">
            CALIFORNIA USERS AND RESIDENTS
          </a>
        </li>
        <li>
          <a href="#miscellaneous" className="text-blue-600">
            MISCELLANEOUS
          </a>
        </li>
        <li>
      ...
      <div>
        ...
        <p>
          ...
          Bookwords LLC (&quot;Company,&quot; “we,&quot; “us,&quot; or “our”),
          concerning your access to and use of the https://bookwords.org website
        ...
        <h2 id="user-generated-contribution">6. USER GENERATED CONTRIBUTION</h2>
        <p>
        ...
        <h2 id="submissions">9. SUBMISSIONS</h2>
        <p>
        ...
        <h2 id="third-party-website-and-content">
        ...
        <h2 id="site-management">12. SITE MANAGEMENT</h2>
        <p>
        ...
        <h2 id="term-and-termination">15. TERM AND TERMINATION</h2>
        <p>
        ...
        <h2 id="modifications-and-interruptions">
        ...
        <p>
          ...
          Chautauqua, New York. Except as otherwise provided herein, the Parties
        ...
        <p>
          ...
          and federal courts located in Chautauqua, New York, and the Parties
        ...
        <h2 id="california-users-and-residents">
        ...
        <p>
          <strong>Bookwords LLC</strong>
        </p>
        <p>
          Email: <a href="mailto:hello@bookwords.org">hello@bookwords.org</a>
        </p>
      </div>
    </div>
  )
